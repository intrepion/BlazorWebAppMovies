...
public class CastMemberGridQueryAdapter
{
    ...
    private readonly Dictionary<CastMemberFilterColumns, Expression<Func<CastMember, string>>> expressions =
        new()
        {
            ...
            { CastMemberFilterColumns.Name2, x => x != null && x.Name2 != null ? x.Name2 : string.Empty },
    ...
    public CastMemberGridQueryAdapter(ICastMemberFilters controls)
    {
        ...
        filterQueries =
            new()
            {
                ...
                // { CastMemberFilterColumns.Name, x => x.Where(y => y != null && y.Name != null && this.controls.FilterText != null && y.Name.Contains(this.controls.FilterText) ) },
            };
    }
