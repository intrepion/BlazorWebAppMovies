...
public class CastMemberMovieGridQueryAdapter
{
    ...
    private readonly Dictionary<CastMemberMovieFilterColumns, Expression<Func<CastMemberMovie, string>>> expressions =
        new()
        {
            ...
            // { CastMemberMovieFilterColumns.Name, c => c != null && c.Name != null ? c.Name : string.Empty },
        };
    ...
    public CastMemberMovieGridQueryAdapter(ICastMemberMovieFilters controls)
    {
        ...
        filterQueries =
            new()
            {
                ...
                // { CastMemberMovieFilterColumns.Name, cs => cs.Where(c => c != null && c.Name != null && this.controls.FilterText != null && c.Name.Contains(this.controls.FilterText) ) },
            };
    }
