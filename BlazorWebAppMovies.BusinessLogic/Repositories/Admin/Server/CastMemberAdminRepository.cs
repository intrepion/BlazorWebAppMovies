...
public class CastMemberAdminRepository(ApplicationDbContext applicationDbContext) : ICastMemberAdminRepository
{
    ...
    public async Task<CastMemberAdminDto?> AddAsync(CastMemberAdminDto castMemberAdminDto)
    {
        ...
        if (string.IsNullOrWhiteSpace(castMemberAdminDto?.Name2 ?? string.Empty))
        {
        ...
        castMember.NormalizedName1 = castMemberAdminDto?.Name1 ?? string.Empty.ToUpperInvariant();
        castMember.NormalizedName2 = castMemberAdminDto?.Name2 ?? string.Empty.ToUpperInvariant();
